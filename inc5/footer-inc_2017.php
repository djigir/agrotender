		...
		?>
				...
				<div class="frm-row">
					<div class="frm-col2">					
						...
						<div class="frm-inp"><input type="text" id="compfio" name="compfio" value="<?=( $compinfo['id'] != 0 ? $compinfo['bname'] : $UserName );?>"></div>
				...
				<div class="frm-row">
					<div class="frm-col2">					
						...
						<div class="frm-inp"><input type="text" id="comptel" name="comptel" value="<?=( $compinfo['id'] != 0 ? $compinfo['bphone'] : $reqmail );?>"></div>
				...
				<div class="frm-row">
					<div class="frm-col2">					
						...
						<div class="frm-inp"><input type="text" id="compmail" name="compmail" value="<?=( $compinfo['id'] != 0 ? $compinfo['bemail'] : $reqmail);?>"></div>
				...
				<div class="frm-row ta_center" style="padding-bottom: 14px;"><input type="submit" class="btn btn-light" onclick="yaCounter117048.reachGoal('MessendgerSend')" value="Отправить предложение"></div>
				</form>
				<div class="both"></div>
			</div>
		</div>
