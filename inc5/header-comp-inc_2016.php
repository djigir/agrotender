...
<?php
	...
	$COMPURL_TRANSLATE = Array(0, 6, 7, 2, 1, 3, 4, 5, 9);
	...
	$COMP_PAGES_CFG = Array(
		...
		$CCAB_BLK_ALLADVS => Array("url" => "publ", "name" => "Торговая площадка", "urlid" => -1)
	);
	$COMP_PAGES = Array();
	...
	?>
		...
		<div id="left">
			<div id="header"<?=( $COMP_HEADPIC != "" ? ' style="background-image: url('.$PICHOST.$COMP_HEADPIC.');"' : '' );?>>
				<div id="logo">
					<a href="<?=$COMPURL0;?>"><img src="<?=( isset($COMP_LOGO) ? $COMP_LOGO : '/compimg/logo-sample.jpg' );?>" alt="<?=( isset($COMP_NAME) ? $COMP_NAME : 'Компания на Агротендер' );?>" width="150" height="149" /></a>
				</div>
