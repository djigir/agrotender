...
function Trader_BuildUrl($trid, $trurl, $oblurl="", $culturl="", $typeurl="", $onlyport="", $curtype=-2, $removepars=false)
{
...
function trPlaces_ByCult($trader_id, $cults, $obls, $acttype=0, $place_type=-1)
{
	global $TABLE_TRADER_PR_PRICES, $TABLE_TRADER_PR_PLACES;
