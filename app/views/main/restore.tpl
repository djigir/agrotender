      ...
      <form class="form restore">
        <div class="content-block mt-4 p-3 p-sm-5">
          ...
          <button type="submit" href="#" class="top-btn btn btn-primary align-bottom mt-4 d-block d-sm-none">
            <span class="pl-1 pr-1 btn-text">Восстановить</span>
        ...
        <div class="mt-4 mb-4 text-center text-sm-left">
          <a href="/buyerlog" class="d-block d-sm-inline-block mb-4"><i class="fal fa-chevron-left mr-1"></i> <span>Вход</span></a>
