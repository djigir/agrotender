...
<p style="font-size: 12px; line-height: 27px; margin: 0;"><span style="font-size: 18px;">Вы запросили изменение логина на <b>{$email}</b>.
Чтобы завершить процесс смены логина, нажмите на кнопку ниже:</span></p>
</div>
</div>
<!--[if mso]></td></tr></table><![endif]-->
<!--[if (!mso)&(!IE)]><!-->
...
<!--[if mso]><table width="100%" cellpadding="0" cellspacing="0" border="0" style="border-spacing: 0; border-collapse: collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;"><tr><td style="padding-top: 10px; padding-right: 10px; padding-bottom: 10px; padding-left: 10px" align="center"><v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="https://agrotender.com.ua/changeEmail/{$id}/{$emailHash}" style="height:54pt; width:271.5pt; v-text-anchor:middle;" arcsize="13%" stroke="false" fillcolor="#285ca1"><w:anchorlock/><v:textbox inset="0,0,0,0"><center style="color:#ffffff; font-family:'Trebuchet MS', Tahoma, sans-serif; font-size:26px"><![endif]--><a href="https://agrotender.com.ua/changeEmail/{$id}/{$emailHash}" style="-webkit-text-size-adjust: none; text-decoration: none; display: inline-block; color: #ffffff; background-color: #285ca1; border-radius: 9px; -webkit-border-radius: 9px; -moz-border-radius: 9px; width: auto; width: auto; border-top: 1px solid #285ca1; border-right: 1px solid #285ca1; border-bottom: 1px solid #285ca1; border-left: 1px solid #285ca1; padding-top: 10px; padding-bottom: 10px; font-family: 'Montserrat', 'Trebuchet MS', 'Lucida Grande', 'Lucida Sans Unicode', 'Lucida Sans', Tahoma, sans-serif; text-align: center; mso-border-alt: none; word-break: keep-all;" target="_blank"><span style="padding-left:45px;padding-right:45px;font-size:26px;display:inline-block;">
