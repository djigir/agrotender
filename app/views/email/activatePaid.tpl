...
<p style="line-height: 26px; text-align: center; font-size: 12px; margin: 0;"><span style="font-size: 22px;">Здравствуйте!<br/>Вы успешно активировали платные услуги.</span></p>
</div>
</div>
<!--[if mso]></td></tr></table><![endif]-->
<!--[if (!mso)&(!IE)]><!-->
...
<li style="font-size: 14px; line-height: 21px;"><span style="line-height: 24px; font-size: 16px;"><strong>{$data['title']} (до {$data['date']})</strong></span></li>
{/foreach}
</ul>
</div>
</div>
