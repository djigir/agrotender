      ...
      <header class="header">
        ...
        <div class="mobileMenu">
          <div class="container p-0">
            ...
            <div class="links">
              {$mobile}
              <a href="https://agrotender.com.ua/traders_forwards/region_ukraine/kukuruza?viewmod=tbl">
        ...
        <div class="userMobileMenu">
          ...
          <div class="items d-flex flex-column justify-content-between">
            {$menu}
            <a href="https://agrotender.com.ua/traders_forwards/region_ukraine/pshenica_2_kl?viewmod=tbl">
              <b>Форварды<sup style="color: #ffd16d"> new</sup></b>
            </a>
          </div>
        </div>
