<div class="container company mb-5">
  ...
  <div class="content-block prices-block{if $regionsPrices neq null} mb-5{/if}"  style="position: relative">
      ...
      <div class="tableFirst" style="position: relative; z-index: 1;overflow: hidden;">
        ...
        <tr>
          ...
          <td place="{$place['id']}" rubric="{$rubric['id']}" currency="1" class="currency-1{if $issetUahPort eq null} d-table-cell{/if}">
            {if !empty($rubric['price'][1])}<div class="d-flex align-items-center justify-content-center lh-1"><span class="font-weight-600">{$rubric['price'][1]['cost']}</span> {if $rubric['price'][1]['change_price'] neq ''}&nbsp;<img src="/app/assets/img/price-{$rubric['price'][1]['change_price']}.svg">&nbsp; <span class="price{if $rubric['price'][1]['change_price'] neq ''}-{$rubric['price'][1]['change_price']}{/if}"> {$rubric['price'][1]['price_diff']|ltrim:'-'}</span>{/if}</div>{/if}
  ...
  <div class="content-block trader-contact py-3 px-4">
    ...
    <div class="contacts mt-4">
      ...
      {if $contact['dolg'] neq null or $contact['fio'] neq null or $contact['phone'] neq null or $contact['email'] neq null}
    ...
    <div class="position-relative w-100">
      <div class="col-12 col-md-4 float-left mt-4 mt-md-0 d-flex d-sm-block">
        ...
        <div class="d-none d-sm-block">
          <a href="/kompanii/comp-{$company['id']}-news" class="small show-all mb-1 d-none d-sm-inline-block">Смотреть все</a>
        </div>
        <a href="/kompanii/comp-{$company['id']}-news" class="show-all float-right d-block d-sm-none align-self-center ml-auto ml-sm-2-relative">Все &nbsp;<i class="fas fa-angle-right position-absolute"></i></a>
      </div>
    </div>
  </div>
  <div class="row">
  ...
  {/if}
    <div class="col-12 col-sm-4">
      <div class="content-block newsItem d-flex align-items-center py-2 px-1">
        ...
        <a class="ml-2" href="/kompanii/comp-{$company['id']}-news-{$newsItem['id']}">{$newsItem['title']}</a>
      </div>
    </div>
  {/foreach}
  </div>
  ...
  <div class="row mt-4 mb-2">
    <div class="position-relative w-100">
      <div class="col-12 col-md-4 float-left mt-4 mt-md-0 d-flex d-sm-block">
        ...
        <div class="d-none d-sm-block">
          <a href="/kompanii/comp-{$company['id']}-vacancy" class="small show-all mb-1 d-none d-sm-inline-block">Смотреть все</a>
        </div>
        <a href="/kompanii/comp-{$company['id']}-vacancy" class="show-all float-right d-block d-sm-none align-self-center ml-auto ml-sm-2-relative">Все &nbsp;<i class="fas fa-angle-right position-absolute"></i></a>
      </div>
    </div>
  </div>
  <div class="row">
  ...
  {/if}
    <div class="col-12 col-sm-4">
      <div class="content-block vacancyItem d-flex align-items-center py-3 px-3">
        <a class="ml-2" href="/kompanii/comp-{$company['id']}-vacancy-{$vacancyItem['id']}">{$vacancyItem['title']}</a>
      </div>
    </div>
  {/foreach}
  </div>
  ...
  <div class="row mt-4 mb-2">
    <div class="position-relative w-100">
      <div class="col-12 col-md-4 float-left mt-4 mt-md-0 d-flex d-sm-block">
        ...
        <div class="d-none d-sm-block">
          <a href="/kompanii/comp-{$company['id']}-reviews" class="small show-all mb-1 d-none d-sm-inline-block">Смотреть все</a>
        </div>
        <a href="/kompanii/comp-{$company['id']}-reviews" class="show-all float-right d-block d-sm-none align-self-center ml-auto ml-sm-2-relative">Все &nbsp;<i class="fas fa-angle-right position-absolute"></i></a>
      </div>
    </div>
  </div>
  <div class="row">
