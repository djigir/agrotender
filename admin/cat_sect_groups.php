<?php
	...
	$PAGE_HEADER['ru'] = "Тематические группы в каталоге";
	...
	$THIS_TABLE = $TABLE_CAT_SECTGROUPS;
...
?>
	...
	<h3>Редактировать группу каталога</h3>
...
<?php
	...
	{
?>
	<h3>Добавить группу каталога</h3>
    <table align="center" cellspacing="0" cellpadding="1" border="0" class="tableborder">
    <tr><td>
    	<table width="100%" cellspacing="1" cellpadding="1" border="0">
    <form action="<?=$PHP_SELF;?>" method="POST">
...
<?php
   		...
   		if( $res = mysqli_query($upd_link_db,"SELECT * FROM $THIS_TABLE ORDER BY sect0lev_id,sort_num") )
		{
			while($row=mysqli_fetch_object($res))
			{
                ...
                echo "<td>".stripslashes($row->url)."</td>";
