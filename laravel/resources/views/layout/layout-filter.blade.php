...
{{--                         active Клас добавляю кастомно пока что не рабоает из js   --}}
                            <div class="new_filters_dropdown-content 1 active" id="cereals">
                                <ul>
                                    @foreach($rubricsGroup["Зерновые"]["groups"]["traders_products"] as $index => $item)

                                        @if($index > count($rubricsGroup["Зерновые"]["groups"]["traders_products"]) / 2)
                                            <li>
                                                <a href="/traders/region_ukraine/{{$rubricsGroup["Зерновые"]["groups"]["traders_products"][$index]['url']}}?viewmod=nontbl">
                                                    {{$rubricsGroup["Зерновые"]["groups"]["traders_products"][$index]['name']}}
{{--                                                    (50)--}}
                                                </a>
                                            </li>
                                        @endif
                                ...
                                <ul>
                                    @foreach($rubricsGroup["Зерновые"]["groups"]["traders_products"] as $index => $item)
                                        @if($index < count($rubricsGroup["Зерновые"]["groups"]["traders_products"]) / 2)
                                            <li>
                                                <a href="/traders/region_ukraine/{{$rubricsGroup["Зерновые"]["groups"]["traders_products"][$index]['url']}}">
                                                    {{$rubricsGroup["Зерновые"]["groups"]["traders_products"][$index]['name']}}
{{--                                                    (50)--}}
                                                </a>
                                            </li>
...
{{--                                <ul>--}}
{{--                                    <li>--}}
{{--                                        <a href="/traders/tport_berdjansk/index">--}}
{{--                                            Бердянский МП--}}
{{--                                        </a>--}}
{{--                                    </li>--}}
{{--                                    <li>--}}
{{--                                        <a href="/traders/tport_mariupolskij/index">--}}
{{--                                            Мариупольский МП--}}
{{--                                        </a>--}}
{{--                                    </li>--}}
{{--                                    <li>--}}
{{--                                        <a href="/traders/tport_navallogistik/index">--}}
{{--                                            Наваль Логистик--}}
{{--                                        </a>--}}
{{--                                    </li>--}}
{{--                                    <li>--}}
{{--                                        <a href="/traders/tport_nikatera/index">--}}
{{--                                            Ника-Тера--}}
{{--                                        </a>--}}
{{--                                    </li>--}}
{{--                                    <li>--}}
{{--                                        <a href="/traders/tport_nikolaevskij/index">--}}
{{--                                            Николаевский МП--}}
{{--                                        </a>--}}
{{--                                    </li>--}}
{{--                                    <li>--}}
{{--                                        <a href="/traders/tport_nikolaevskijrp/index">--}}
{{--                                            Николаевский РечПорт--}}
{{--                                        </a>--}}
{{--                                    </li>--}}
{{--                                    <li>--}}
{{--                                        <a href="/traders/tport_odesskij/index">--}}
{{--                                            Одесский МП--}}
{{--                                        </a>--}}
{{--                                    </li>--}}
{{--                                    <li>--}}
{{--                                        <a href="/traders/tport_olvia/index">--}}
{{--                                            Ольвия МП--}}
{{--                                        </a>--}}
{{--                                    </li>--}}
{{--                                    <li>--}}
{{--                                        <a href="/traders/tport_hersonskij/index">--}}
{{--                                            Херсонский МП--}}
{{--                                        </a>--}}
{{--                                    </li>--}}
{{--                                    <li>--}}
{{--                                        <a href="/traders/tport_hersonskijrp/index">--}}
{{--                                            Херсонский РечПорт--}}
{{--                                        </a>--}}
{{--                                    </li>--}}
{{--                                    <li>--}}
{{--                                        <a href="/traders/tport_chernomorskij/index">--}}
{{--                                            Черноморский МП--}}
{{--                                        </a>--}}
{{--                                    </li>--}}
{{--                                    <li>--}}
{{--                                        <a href="/traders/tport_ochakov/index">--}}
{{--                                            Ю-Порт Очаков--}}
{{--                                        </a>--}}
{{--                                    </li>--}}
{{--                                    <li>--}}
{{--                                        <a href="/traders/tport_juzhnyj/index">--}}
{{--                                            Южный МП--}}
{{--                                        </a>--}}
{{--                                    </li>--}}
{{--                                </ul>--}}
