                ...
                <div class="row content-block postItem mx-0 mt-3 mt-sm-4 pt-2 pb-2 py-sm-3 px-1">
                    <div class="row mx-0 w-100">
                        <div class="col-auto pr-0 pl-1 pl-sm-3">
                            ...
                            ?>
                            <img src="{{$src_img && file_exists($src_img) ? $src_img : '/app/assets/img/no-image.png'}}" class="postImg" alt="{{$advert->title_post}}">
                                ...
                                <div class="col p-0">
                                    ...
                                    <div class="row ml-0 mr-3 mt-1">
                                        <div class="col-sm-9 pl-1 pl-sm-0 d-none d-sm-flex">
                                            <span class="region align-self-center">{{$advert->region}} область, {{$advert->city}}</span>
                                        </div>
