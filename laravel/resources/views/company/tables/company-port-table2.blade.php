<div class="ports-tabs table-tabs mt-3">
     <a id="port-uah" class="region-port-table">Закупки UAH</a>
                                ...
                                @if(isset($port_price[$place['id']][$data_port['cult_id']][0]))
                                    <td class="port-UAH">
                                        <div class="d-flex align-items-center justify-content-center lh-1">
                                            <span class="font-weight-600">{{round($port_price[$place['id']][$data_port['cult_id']][0]['costval'], 1)}}</span> &nbsp;
                                        </div>
                                    </td>
                                @endif
                                @if(isset($port_price[$place['id']][$data_port['cult_id']][1]))
                                    <td class="port-USD" style="{{(!empty($port_price[$place['id']][$data_port['cult_id']][0])) ? 'display: none' : ''}}">
                                        <div class="d-flex align-items-center justify-content-center lh-1">
                                            <span class="font-weight-600">{{round($port_price[$place['id']][$data_port['cult_id']][1]['costval'], 1)}}</span> &nbsp;
                                        </div>
                                    </td>
                                @endif
                            @else
