    ...
    <div class="container mt-4 mb-5">
        ...
        <div class="content-block mt-4 px-5 py-3 personal mx-0 mx-sm-5">
            <div class="pt-2 row d-block d-sm-flex mx-sm-0">
                <b>Ваш текущий логин:</b> &nbsp;<span class="d-block d-sm-inline-block">dmitriy.thorzhevskii@gmail.com</span>
            </div>
            <hr class="my-4">
            <h5>Сменить пароль</h5>
            <form class="form change-password mt-0 mt-sm-3" novalidate="novalidate">
            ...
            <form class="form change-login mt-0 mt-sm-3" novalidate="novalidate">
                <div class="form-group row d-flex align-items-center py-1 mb-2 mt-2">
