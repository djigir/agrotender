...
class BreadcrumbService
{
    ...
    const REGION_CULTURE = [
        ...
        8 => [
          ...
          8 => 'Цена пшеницы 2 класса в Запорожье от трейдеров'
        ],
        10 => [
        ...
        14 => [
            ...
            24 => 'Оптовые цены семечки подсолнечника в Николаевской области'
        ],
        15 => [
            ...
            39 => 'Закупочная цена льна от зернотрейдеров Одессы',
            28 => 'Цена нута у закупщиков в Одесской области',
        ],
        16 => [
        ...
        22 => [
            ...
            39 => 'Стоимость продажи льна в Хмельницкой области',
        ],
        23 => [
    ...
    const NAME = [
        ...
        46 => 'Каталог – Торговля Агрохимией в Украине',
    ...
    const NAME_REGION = [
        ...
        46 => 'Каталог – Торговля Агрохимией в ',
    ...
    const OTHER_TEXT =
        ...
        43 => 'Отруби пшеничные гранулированные',
    ];
