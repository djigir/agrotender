...
<div class="float_r"><!--LiveInternet counter--><script type="text/javascript"><!--
		...
		<div class="wnd-popup-box">			
			<div class="wnd-popup-in">
				...
				<div class="log-frm">
					...
					<div class="frm-lnk"><a href="<?=Page_BuildUrl($LangId,"buyerlog", "");?>" onclick="yaCounter117048.reachGoal('Pop-up-cant-in')"><span>Не могу войти.</span></a></div>
					</form>
				</div>
				</div>
			</div>
